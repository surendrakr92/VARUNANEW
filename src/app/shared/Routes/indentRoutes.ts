...
import { KantaWeightComponent } from "src/app/main/indent-management/KantaWeight/kanta-weight/kanta-weight.component";
...
export const IndentRoutes: Routes = [
    {
      ...
      {
        path:'KantaWeight',component:KantaWeightComponent
      }
